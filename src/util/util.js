...
module.exports = {
    ...
    getRandomUserAgent() {
        const user_agents = [
            ...
            'Mozilla/5.0 (Linux; U; Android 5.0; en-US; V80 Build/LRX21M) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/57.0.2987.108 UCBrowser/12.9.7.1153 Mobile Safari/537.36',
